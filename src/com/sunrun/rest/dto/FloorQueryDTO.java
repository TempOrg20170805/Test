 ...
 * 描 述：楼DTO 查询结果
 */
public class FloorQueryDTO extends BaseDTO {
	public enum FloorQueryDTOEnum implements BaseStateDTOEnum{
		;
		
		private Integer stateCode;
		private String msg;
		private FloorQueryDTOEnum(Integer stateCode, String msg) {
