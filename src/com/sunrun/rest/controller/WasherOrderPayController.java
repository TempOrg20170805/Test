...
import com.sunrun.common.util.alipay.util.AlipayNotify;
...
public class WasherOrderPayController extends BaseController{
	...
	public void alipayScoreOrderCallBack(HttpServletRequest request, HttpServletResponse response) {
