...
public class CmsUser extends BaseCmsUser implements PriorityInterface {
	...
	public enum realnameStatusEnum {
	   ...
	   * 3·通过实名
	   */
	   PASS_REALNAME("通过实名",3),
	   /**
	    * 4·未通过
	    */
	   NOT_PASS_REALNAME("实名通过",4),
	   /**
	    * 5·认证中
	    */
	   BRGIN_REALNAME("认证中",5);
				
		private String name;
		private Integer value;
		private realnameStatusEnum(String name, Integer value) {
			this.name = name;
			this.value = value;
		}
		...
		public static String getNameByValue(Integer value) {
			for (realnameStatusEnum statusEnumEnum : realnameStatusEnum.values()) {
				if (statusEnumEnum.getValue().equals(value)) {
					return statusEnumEnum.getName();
				}
			}
			return "";
		}
	...
	public String getRealStateName(){
		return realnameStatusEnum.getNameByValue(this.getRealnameStatus());
	...
	public String getFullFace() {
		CmsUserExt ext = getUserExt();
		if (ext != null) {
			return ext.getFullFace();
		} else {
			return null;
		}
	}
	
	public String getReverseFace() {
		CmsUserExt ext = getUserExt();
		if (ext != null) {
			return ext.getReverseFace();
		} else {
			return null;
		}
	}
	...
	public void init() {
		...
		if (getRealnameStatus()== null) {
			setRealnameStatus(1);//安装员民警后台注册 ，不需要实名认证
		}
	}
	...
	public CmsUser(java.lang.Integer id,
			...
			java.lang.String username, java.lang.String nickname, java.util.Date registerTime,
