...
public class UserApiAct {
		...
		if(errors.hasErrors()){
			...
			if(record!=null){
				...
				if(user==null){
					...
					user=cmsUserMng.registerMember(null,null,username, email, loginPassword, ip, null,null,disabled,userExt,attrs);
	...
	private String thirdLoginGetSessionKey(ApiAccount apiAccount,
		...
		if(thirdAccount!=null){
			...
			CmsUser user=cmsUserMng.registerMember(null,null,username, null, thirdKey, ip, null,null,disabled,userExt,null);
